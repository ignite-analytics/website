...
(function() {
  function MeetingEmbed() {
    ...
    var c,
      h = document.querySelectorAll(".meetings-iframe-container");
    for (c = 0; c < h.length; c++) {
      ...
      p.src = l + o(d) + n();
      p.width = "100%";
      p.style.minWidth = "312px";
      p.style.minHeight = "516px";
      p.style.height = "756px";
      p.style.border = "none";
      if (!t(x)) {
        x.appendChild(p);
      ...
      function m(t) {
        ...
        u(t.origin) && n.height && (p.style.height = n.height + "px");
      }
    }
  }
